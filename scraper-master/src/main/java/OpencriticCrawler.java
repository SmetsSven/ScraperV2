...
//    static String[] url = {"https://opencritic.com/browse/ps4", "https://opencritic.com/browse/pc"};
    ...
    static String baseurl = "https://opencritic.com/";
    ...
    private static void getVideoGames(String url, int page, int index) throws IOException{
        try{
            ...
            for(Element repository : repositories ){
                ...
                String game_url = repository.select("div.game-name a").attr("href");
                if(Integer.parseInt(score.get(0).text()) < 75){
                    return;
                }
                if(month.equals("")){
//                    System.out.println(date.get(0).text());
//                    System.out.println("=HYPERLINK(\"" + baseurl + game_url + "\";\"" + name.get(0).text() + "\")");
